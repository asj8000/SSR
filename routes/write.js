...
router.get('/write', (req, res) => {
    res.render('write', { name: '', email: '', classNum: '반', number: '번호', position: '희망 지원분야', password: '', application: '', isBlocked: require('../config/status').isBlocked });
});
router.get('/anBn7Kex7Kex66eo', function(req, res, next) {
  res.render('Easter_agg_1');
});
router.get('/cG5n64GE7KGN', function(req, res, next) {
  res.render('Easter_agg_2');
});
